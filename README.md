<h1 align="center">Hi 👋, I'm 9rinx</h1>
<p align="center">Developer & reverse / security engineer from Morocco 🇲🇦</p>

<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=20&pause=1000&color=BD93F9&center=true&vCenter=true&width=460&lines=Reverse+engineering;Binary+exploitation;Malware+analysis;Breaking+things+to+understand+them" alt="typing" />
</p>
...
struct dev {
    ...
    char *focus[3];  // { "reverse engineering", "binary exploitation", "appsec" }
    char *learning;  // "Rust, C internals"
    char *os;        // "Arch Linux + Hyprland"
};
```

- 🔍 I take software apart to understand how it really works
- 🛠️ Building tooling for static & dynamic analysis
...
<p>
  ...
  <img src="https://img.shields.io/badge/Frida-E86D5E?style=for-the-badge&logoColor=white" />
